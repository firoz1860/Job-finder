...
//           </Grid>
//           <Grid item>Posted By : {job.recruiter?.name|| "Unknown Recruiter"}</Grid>
...
//   // })
//   // .then((response) => {
//   //   console.log("🚀 Full job response:", response.data); // DEBUG

//   //   const today = new Date();
//   //   const validJobs = response.data.filter((obj) => {
//   //     const deadline = new Date(obj.deadline);
//   //     return deadline > today;
//   //   });

//   //   console.log("✅ Jobs after filtering by deadline:", validJobs); // DEBUG
//   //   setJobs(validJobs);
//   // })
//   // .catch((err) => {
//   //   console.log("❌ Error fetching jobs:", err.response?.data || err.message);
//   //   setPopup({
//   //     open: true,
//   //     severity: "error",
//   //     message: "Error fetching jobs",
